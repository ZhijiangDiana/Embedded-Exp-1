...
/* local functions                                                           */
/*---------------------------------------------------------------------------*/
static void DMACIntHandle(uint8_t Ch);
...
{
    DMACIntHandle(DMAC_CH0);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 1 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH1);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 2 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH2);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 3 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH3);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 4 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH4);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 5 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH5);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 6 IRQ
 **
 ** \param None
 **
 ** \return None
...
{
    DMACIntHandle(DMAC_CH6);
}

/*!
 ******************************************************************************
 ** \brief DMA Channle 7 IRQ
 **
 ** \param None
 **
 ** \return None
