...
/*! \brief MFS I2C Mininum FIFO Channel: 4 */
#define I2C_Ch_FIFOMIN 4
#define I2C_Ch_FIFOMAX 7
/*! \brief MFS I2C Max Channel Number */
#define I2C_Ch_MAX     7

/*! \brief Transmit FIFO:FIFO1; Receive FIFO:FIFO2 */
#define I2C_FIFO1_TX  0x00
/*! \brief Transmit FIFO:FIFO2; Receive FIFO:FIFO1 */
#define I2C_FIFO2_TX  0x01
...
typedef struct
{
    ...
    uint32_t FIFODepth;         //!< FIFO depth
    BOOL RxFIFO;                //!< enable receive fifo
    BOOL TxFIFO;                //!< enable transmit fifo
}MFS_I2CFIFOConfigT;
/*!
******************************************************************************
