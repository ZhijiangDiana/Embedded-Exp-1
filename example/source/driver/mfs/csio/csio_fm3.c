...
void MFS_CSIOConfigWT(uint8_t Ch, MFS_CSIOModeConfigT *pModeConfig)
{
    ...
    pMFS_CSIO_REG_07[Ch]->ESCR = (pMFS_CSIO_REG_07[Ch]->ESCR & ~(CSIO_ESCR_WT0 | CSIO_ESCR_WT1)) | tESCR;
    return;
}
...
void MFS_CSIOConfigDT(uint8_t Ch, MFS_CSIOModeConfigT *pModeConfig)
{
    ...
    pMFS_CSIO_REG_07[Ch]->ESCR = (pMFS_CSIO_REG_07[Ch]->ESCR & ~(CSIO_ESCR_BITLEN_5 | CSIO_ESCR_BITLEN_6 | CSIO_ESCR_BITLEN_7 | CSIO_ESCR_BITLEN_8 | CSIO_ESCR_BITLEN_9)) | tESCR;
    return;
}
...
void MFS_CSIOConfigFByte1(uint8_t Ch, uint8_t FByte1)
{
    ...
    pMFS_CSIO_REG_47[Ch]->FBYTE1 = FByte1;
}
...
void MFS_CSIOConfigFByte2(uint8_t Ch, uint8_t FByte2)
{
    ...
    pMFS_CSIO_REG_47[Ch]->FBYTE2 = FByte2;
}
/*!
 ******************************************************************************
...
void MFS_CSIOEnableFLSTE(uint8_t Ch)
{
    /* Check Cfg parameter */
    ASSERT((Ch <= CSIO_Ch_MAX) && (Ch >= CSIO_Ch_FIFOMIN));
    pMFS_CSIO_REG_47[Ch]->FCR1 = pMFS_CSIO_REG_47[Ch]->FCR1 | CSIO_FCR1_FLSTE;
    return;
}
...
void MFS_CSIOEnableFRIIE(uint8_t Ch)
{
    /* Check Cfg parameter */
    ASSERT((Ch <= CSIO_Ch_MAX) && (Ch >= CSIO_Ch_FIFOMIN));
    pMFS_CSIO_REG_47[Ch]->FCR1 = pMFS_CSIO_REG_47[Ch]->FCR1 | CSIO_FCR1_FRIIE;
    return;
}
...
void MFS_CSIOEnableFIFO2(uint8_t Ch)
{
    /* Check Cfg parameter */
    ASSERT((Ch <= CSIO_Ch_MAX) && (Ch >= CSIO_Ch_FIFOMIN));
    pMFS_CSIO_REG_47[Ch]->FCR0 = pMFS_CSIO_REG_47[Ch]->FCR0 | CSIO_FCR0_FE2;
    return;
}
...
void MFS_CSIOEnableFIFO1(uint8_t Ch)
{
    /* Check Cfg parameter */
    ASSERT((Ch <= CSIO_Ch_MAX) && (Ch >= CSIO_Ch_FIFOMIN));
    pMFS_CSIO_REG_47[Ch]->FCR0 = pMFS_CSIO_REG_47[Ch]->FCR0 | CSIO_FCR0_FE1;
    return;
}
...
FlagStatusT MFS_CSIOGetFLSTStatus(uint8_t Ch)
{
    ...
    return ((FlagStatusT)((pMFS_CSIO_REG_47[Ch]->FCR0 &
...
void MFS_CSIOResetFIFO2(uint8_t Ch)
{
    ...
    pMFS_CSIO_REG_47[Ch]->FCR0 = pMFS_CSIO_REG_47[Ch]->FCR0 | CSIO_FCR0_FCL2;
...
void MFS_CSIOResetFIFO1(uint8_t Ch)
{
    ...
    pMFS_CSIO_REG_47[Ch]->FCR0 = pMFS_CSIO_REG_47[Ch]->FCR0 | CSIO_FCR0_FCL1;
